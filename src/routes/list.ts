...
router.get('/books/completed', (req, res, next) =>
  books.fetchListByStatus(req, res, 'completed', next)
);
router.get('/books/reading', (req, res, next) =>
  books.fetchListByStatus(req, res, 'reading', next)
);
router.get('/books/on-hold', (req, res, next) =>
  books.fetchListByStatus(req, res, 'on-hold', next)
);
router.get('/books/dropped', (req, res, next) =>
  books.fetchListByStatus(req, res, 'dropped', next)
);
router.get('/books/planned', (req, res, next) =>
  books.fetchListByStatus(req, res, 'planned', next)
);
...
router.get('/movies/completed', (req, res, next) =>
  movies.fetchListByStatus(req, res, 'completed', next)
);
router.get('/movies/watching', (req, res, next) =>
  movies.fetchListByStatus(req, res, 'watching', next)
);
router.get('/movies/on-hold', (req, res, next) =>
  movies.fetchListByStatus(req, res, 'on-hold', next)
);
router.get('/movies/dropped', (req, res, next) =>
  movies.fetchListByStatus(req, res, 'dropped', next)
);
router.get('/movies/planned', (req, res, next) =>
  movies.fetchListByStatus(req, res, 'planned', next)
);
